...
//  PFXRxSwift
//
//  Created by succorer on 2019. 1. 15..
...
class MainTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        guard let path = Bundle.main.path(forResource: "lectures", ofType: "plist") else { return }
        guard let lists = NSArray(contentsOfFile: path) else  { return }
        self.lists = lists
    }
